...
if "%CUDA_VERSION%"=="" (
    ...
    "%~dp0\python-3.10.11-embed\python.exe" -m pip install llama-cpp-python --no-deps --no-cache-dir --force-reinstall --upgrade --extra-index-url https://abetlen.github.io/llama-cpp-python/whl/cu123
    echo Done
)